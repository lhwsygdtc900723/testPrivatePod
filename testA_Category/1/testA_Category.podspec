...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is testA_Category
                   DESC

  s.homepage     = "https://github.com/lhwsygdtc900723/testA_Category"
  ...
  s.source       = { :git => "https://github.com/lhwsygdtc900723/testA_Category.git", :tag => s.version.to_s }
  ...
  s.source_files  = "testA_Category/testA_Category/**/*.{h,m}"
